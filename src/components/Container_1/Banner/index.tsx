...
export function Banner() { 
   ...
   return (
      ...
      <Flex w='100vw'   fontFamily='Heebo' cursor='pointer' h='100%' boxShadow='lg' justifyContent='center' color='white' bgImage={['static/img/bequers.png','static/img/blend-4.gif','static/img/blend-4.gif','static/img/blend-4.gif']} bgSize='cover' onClick={onOpen}>
