      ...
      <Grid w='90vw' py='5' alignItems='baseline'
         ...
         <GridItem mt='auto' display={['none', 'none', 'none', 'GridItem']} >
            ...
            <SimpleGrid ml='auto' w='9rem' columns={4} pb={3} mt='auto' fontSize='1.6rem'>
               <Link _hover={{ color: "teal.400" }} mt='auto' href='https://www.instagram.com/farmaciadaterra/'> <InstagramLogo /> </Link>
               <Link _hover={{ color: "teal.400" }} mt='auto' href='https://www.facebook.com/daterraoficial?ref=hl'> <FacebookLogo /> </Link>
               <Link _hover={{ color: "teal.400" }} mt='auto' href='https://br.linkedin.com/company/daterra---farm%C3%A1cia-de-manipula%C3%A7%C3%A3o-e-cosm%C3%A9ticos'> <LinkedinLogo /> </Link>
               <Link _hover={{ fontSize: "3rem", transition: '200ms' }} color='#6cd474' fontSize='2.8rem' href='https://wa.me/5516991790291'> <WhatsappLogo weight="fill" /> </Link>
         ...
         >
            ...
            >
               ...
               <SimpleGrid mx='auto' w='9rem' columns={4} py={3} mt='auto' fontSize='1.6rem'>
                  ...
                  <Link _hover={{ color: "teal.400" }} mt='auto' href='https://www.facebook.com/daterraoficial?ref=hl'> <FacebookLogo /> </Link>
                  <Link _hover={{ color: "teal.400" }} mt='auto' href='https://br.linkedin.com/company/daterra---farm%C3%A1cia-de-manipula%C3%A7%C3%A3o-e-cosm%C3%A9ticos'> <LinkedinLogo /> </Link>
                  <Link color='#6cd474' fontSize='1.6rem' href='https://wa.me/5516991790291'> <WhatsappLogo /> </Link>
                  {/* <Image w='70px' src='images/zap.png' alt='Dan Abramov' /> */}
               </SimpleGrid >
            </Flex>
