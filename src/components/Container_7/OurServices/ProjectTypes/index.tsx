...
const subtitle = <>Contrate a empresa no formato <b>Full Service</b> ou terceirize algumas etapas do processo.</>
...
export function ProjectTypes() {
   ...
   return (
      <GridItem colSpan={12} bg={['white', 'white', 'none', 'none']} w='100%' p={[2, 4, 8, 4]} my={[8, 8, 2, 6]} maxW={1920}>
         ...
         <Grid templateColumns='repeat(12, 1fr)' gap={[0, 6, 6, 0]} pl={[0, 0, 0, 0, 0]} color='datBlue' fontWeight='500'>
            ...
            <GridItem textAlign={['center', 'center', 'left', 'left']} colSpan={[12, 12, 12, 4]} py={[0, 8, 8, 8]} px={[8, 8, 8, 4]}>
               <Text fontSize={['1.7rem', '1.9rem', '1.4rem', '2rem']} color={['datDarkBlue', 'datDarkBlue', 'datBlue', 'white']} fontWeight={['200','200','200','bold','bold']} textTransform='uppercase'>
